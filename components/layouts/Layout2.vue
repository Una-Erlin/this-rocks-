...
<template>
  <div class="layout2">
    ...
    <div class="relative max-h-screen overflow-hidden z-1">
      ...
      <div
        class="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 animate-fa
        de animate-once animate-delay-[500ms]"
        v-if="imageLoaded"
      >
        <div class="container p-4">
          <div class="rubik-dirt-regular">
    ...
    <div class="container mx-auto p-4 animate-fade animate-once animate-delay-[500ms]" v-if="imageLoaded">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
        <!-- First column -->
        <div>
          <h1 class="rubik-dirt-regular text-3xl md:text-3xl lg:text-6xl lg:mb-3 font-bold">{{ data.title }}</h1>
