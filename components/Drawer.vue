<template>
  <div class="flex animate-fade animate-once animate-delay-[500ms]">
    ...
    <div class="flex-row pt-5 justify-end animate-pulse">
      <button style="margin-left: 16px" @click="drawer = true" class="bg-white dark:bg-slate-100 bg-opacity-70 hover:bg-opacity-90 dark:bg-opacity-90 ">
...
.fixed-drawer {
  ...
  background-color: rgba(123, 123, 123, 0.99);
}
