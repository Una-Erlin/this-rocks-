        ...
        <div class="info flex flex-col items-center justify-center h-screen relative">
          <div class="container text-left p-1 lg:p-20">
            ...
            >
              <!-- Title -->
              <div class="relative">
                <div class="blur-text text-6xl font-bold rubik-dirt-regular">{{ displayedTitle }}</div>
                <div class="text-6xl font-bold border-r-4 border-white pr-2 animate-blink rubik-dirt-regular">
                  {{ displayedTitle }}
                </div>
              </div>
              ...
              <div class="relative mt-4">
                <div class="blur-text text-2xl rubik-dirt-regular">{{ displayedSubtitle }}</div>
                <div class="text-2xl rubik-dirt-regular">{{ displayedSubtitle }}</div>
              </div>
